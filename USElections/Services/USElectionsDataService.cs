        ...
        public BehaviorSubject<Candidate> RepublicanCandidate
        {
            get
            {
                if (republicanCandidate == null)
                {
                    ...
                    _stateService.CurrentlyChosenYear.Subscribe(async _ => republicanCandidate.OnNext(await GetCandidate((int)_stateService.CurrentlyChosenYear.Value)));
                }
        ...
        public BehaviorSubject<Candidate> DemocratCandidate
        {
            get
            {
                if (democratCandidate == null)
                {
                    ...
                    _stateService.CurrentlyChosenYear.Subscribe(async _ => democratCandidate.OnNext(await GetCandidate1((int)_stateService.CurrentlyChosenYear.Value)));
                }
